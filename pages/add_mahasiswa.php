<?php
    ...
    if(isset($_POST['add'])){      
        ...
        $sql = "INSERT INTO data_mahasiswa VALUES('','$nama','$nrp','$jurusan','$prodi', '$jk', '$no_hp', '', '')";
        if(mysqli_query($conn, $sql)){
            echo '<script>';
            echo "alert('Input Berhasil');";
            echo "window.location.href='datamahasiswa.php';";
            echo '</script>';
        }
        else{
            echo '<script>';
            echo "alert('Input GAGAL');";
            echo "window.location.href='add_mahasiswa.php';";
            echo '</script>';   
        }
    }
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form action="add_mahasiswa.php" method="POST" role="form" enctype="multipart/form-data">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>NRP</label>
                                            <input class="form-control" placeholder="Masukkan NRP" name="nrp">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="prodi">
                                                ...
                                                <option value="D4 A">D4 A</option>
                                                <option value="D4 B">D4 B</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="08xxxxxx" name="no_hp">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
