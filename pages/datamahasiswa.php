...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="add_mahasiswa.php" class="btn btn-success" style="float: right;"><b>+</b> Tambah Data</a><br><br>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT id, nama, nrp, jurusan, foto FROM data_mahasiswa";
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td style="text-align: center;">
                                            <a href="viewmahasiswa.php?id=<?php echo $row['id'] ?>" class="btn btn-success btn-sm"><span class="fa fa-eye"></span></a>
                                            <a href="edit_mahasiswa.php?id=<?php echo $row['id'] ?>" class="btn btn-primary btn-sm"><span class="fa fa-pencil"></span></a>
                                            <a href="delete_mhs.php?id=<?php echo $row['id'].'&gambar='.$row['foto'] ?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                                        </td>
                                    </tr>
                                    <?php $no++; } ?>
                                </tbody>
