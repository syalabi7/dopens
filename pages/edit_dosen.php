<?php
    ...
    if(isset($_POST['add'])){      
        ...
        if(mysqli_query($conn, $sql)){
            ...
            echo "window.location.href="."'"."viewdosen.php?id=".$id."';";
            echo '</script>';
        }
        else{
            echo '<script>';
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form action="edit_dosen.php?id=<?php echo $row['id'] ?>" method="POST" role="form" enctype="multipart/form-data">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <label>NIP</label>
                                            <input class="form-control" value="<?php echo $row['nip'] ?>" name="nip">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="agama">
                                                <option <?php if($row['agama'] == 'Islam') echo 'selected = "selected"'; ?> value="Islam">Islam</option>
                                                <option <?php if($row['agama'] == 'Kristen') echo 'selected = "selected"'; ?> value="Kristen">Kristen</option>
                                                <option <?php if($row['agama'] == 'Katholik') echo 'selected = "selected"'; ?> value="Katholik">Katholik</option>
                                                <option <?php if($row['agama'] == 'Hindu') echo 'selected = "selected"'; ?> value="Hindu">Hindu</option>
                                                <option <?php if($row['agama'] == 'Budha') echo 'selected = "selected"'; ?> value="Budha">Budha</option>
                                                <option <?php if($row['agama'] == 'Lainnya') echo 'selected = "selected"'; ?> value="Lainnya">Lainnya</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="status">
                                                <option <?php if($row['status'] == 'Aktif') echo 'selected = "selected"'; ?> value="Aktif">Aktif</option>
                                                <option <?php if($row['status'] == 'Pasif') echo 'selected = "selected"'; ?> value="Pasif">Pasif</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label>Staff</label>
                                            <select class="form-control" name="staff">
                                                <option <?php if($row['staff'] == 'Dosen') echo 'selected = "selected"'; ?> value="Dosen">Dosen</option>
                                                <option <?php if($row['staff'] == 'Karyawan') echo 'selected = "selected"'; ?> value="Karyawan">Karyawan</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Ruang</label>
                                            <input class="form-control" value="<?php echo $row['ruang']; ?>" name="ruang">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
