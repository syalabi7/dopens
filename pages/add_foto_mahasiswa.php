<?php
    ...
    if(isset($_POST['add'])){
        ...
        $filePath = "image/mahasiswa/".$newName;
        $url_foto = "http://localhost/dopens/pages/image/mahasiswa/".$newName;

        $sql = "UPDATE data_mahasiswa SET foto='$newName', url_foto='$url_foto' WHERE id=$id";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <form action="add_foto_mahasiswa.php?id=<?php echo $id; ?>" method="POST" role="form" enctype="multipart/form-data">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12">
                                        <a href="viewmahasiswa.php?id=<?php echo $id; ?>" class="btn btn-danger" name="batal" style="float: left; margin-right: 10px;">X Batal</a>
