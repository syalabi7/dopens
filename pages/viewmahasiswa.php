...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="edit_mahasiswa.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" style="float: right;"><span class="glyphicon glyphicon-pencil"></span>  Edit Data</a><br><br>
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a href="delete_foto_mhs.php?id=<?php echo $id.'&gambar='.$row['foto']; ?>" title="Hapus Foto"><span class="glyphicon glyphicon-trash"></span></a>
                                            <?php }
                                            else{ ?>
                                              <a href="add_foto_mahasiswa.php?id=<?php echo $id ?>" class="btn btn-success" style="float: right;"><span class="glyphicon glyphicon-camera"></span> Tambah Foto</a>  
                                            <?php } ?>
                                        </td>
                                    </tr>
                                    <tr class="odd gradeX">
